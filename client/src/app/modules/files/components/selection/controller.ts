...
class SelectionController {
  ...
  getSelectedItems(): Selections | null {
    ...
    if (
      this.compareArrays(files, this.selectedFiles) &&
      this.compareArrays(folders, this.selectedFolders)
    ) {
      return null
    }
  ...
  createSelectionBox() {
    ...
    SelectionController.selection.style.backgroundColor = transparentize(
      0.75,
      this.color,
    )
  ...
  scroll(e: Event) {
    ...
    if (SelectionController.selection && e.target) {
      ...
      SelectionController.selection.style.top =
        SelectionController.intialTop -
        (scrollTop - SelectionController.intialScrollY) +
        'px'
      SelectionController.selection.style.height =
        SelectionController.intialHeigth +
        (scrollTop - SelectionController.intialScrollY) +
        'px'
