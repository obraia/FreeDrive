...
class DownloadFilesController extends BaseController implements Controller {
  constructor(private readonly useCase: DownloadFilesUseCase) {
    super()
  }
  ...
  public async handle(req: Request, res: Response) {
    ...
    const params = {
      userId: decoded.id,
      filesIds: Params.string(ids).split(';'),
    }
...
export { DownloadFilesController }
